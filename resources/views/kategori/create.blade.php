...
<div class="max-w-2xl mx-auto animate-fade-in">
    ...
    <div class="mb-6">
        ...
        <h3 class="text-xl font-bold text-slate-800 mt-2">Tambah Kategori Baru</h3>
    </div>
    ...
    <div class="bg-white border border-slate-150 rounded-2xl shadow-sm overflow-hidden p-6 md:p-8">
        <form action="{{ route('kategori.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="nama_kategori" id="nama_kategori" required value="{{ old('nama_kategori') }}"
                    class="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent rounded-xl py-3 px-4 text-sm text-slate-800 placeholder-slate-400 focus:outline-none transition-all"
                    placeholder="Contoh: Knalpot, Kelistrikan, Oli">
            </div>
            ...
            <div>
                ...
                <textarea name="deskripsi" id="deskripsi" rows="4"
                    class="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent rounded-xl py-3 px-4 text-sm text-slate-800 placeholder-slate-400 focus:outline-none transition-all"
                    placeholder="Masukkan penjelasan singkat tentang kategori ini...">{{ old('deskripsi') }}</textarea>
            </div>
